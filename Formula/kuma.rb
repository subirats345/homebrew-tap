...
class Kuma < Formula
  ...
  url "https://github.com/subirats345/kuma/archive/refs/tags/v0.9.1.tar.gz"
  sha256 "1d3e9c341e73d4e98e56d7c8f932a23ffda2ca8d95867157ddeaeeb5be4a981c"
  license "MIT"
  depends_on :macos
  ...
  test do
    ...
    assert_match "Kuma 0.9.1", shell_output("#{bin}/kuma --version")
