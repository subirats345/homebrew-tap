...
class Kuma < Formula
  ...
  url "https://github.com/subirats345/kuma/archive/refs/tags/v0.4.1.tar.gz"
  sha256 "499408391c7ee2b95e328d5747f74464faee0f8737999ad108b522d90b64ddc0"
  license "MIT"
  depends_on :macos
  ...
  test do
    ...
    assert_match "Kuma 0.4.1", shell_output("#{bin}/kuma --version")
