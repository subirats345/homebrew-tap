...
class Kuma < Formula
  ...
  url "https://github.com/subirats345/kuma/archive/refs/tags/v0.5.0.tar.gz"
  sha256 "dfcc65beee89fd0be9975ca519ac2c173a1e14f49c72c7a80e56a39763295462"
  license "MIT"
  depends_on :macos
  ...
  test do
    ...
    assert_match "Kuma 0.5.0", shell_output("#{bin}/kuma --version")
